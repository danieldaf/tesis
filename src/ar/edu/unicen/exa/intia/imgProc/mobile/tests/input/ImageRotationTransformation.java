...
/**
 * Aplica un rotacion sobre la imagen.
 * 
 * @author Daniel Fuentes
 *
 */
public class ImageRotationTransformation extends ImageTransformation {
    ...
    /**
     * Configura todas las rotaciones a aplicar, llendo de un angulo inicial a uno final.
     * 
     * @param startAngleInDeg Angulo inicial de rotacion
     * @param endAngleInDeg Angulo final de rotacion
     * @param step Grados de rotacion que deben aplicarse en una rotacion
     * @param rotationCenterInUnitSpace Coordenadas bidimensionales del centro de rotacion a emplear
     */
    public ImageRotationTransformation(double startAngleInDeg, double endAngleInDeg, double step, Point rotationCenterInUnitSpace) {
		super("Rotation");
    ...
    public ImageRotationTransformation() {
    	super("Rotation");
    }
